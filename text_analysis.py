...
class TextEntropyAnalyzer:
    ...
    def analyze_markov_chains(self, text, max_order=2):
...
def plot_ngram_entropy(analyzer, title, figsize=(10, 6)):
    """Plot n-gram entropy progression (1-gram to 8-gram)"""
...
def plot_markov_entropy(analyzer, title, figsize=(10, 6)):
    """Plot Markov chain entropy progression (0th to 7th order)"""
